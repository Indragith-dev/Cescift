  ...
  return (
    <ServicesContainer>
      <HeroSection>
        ...
        <HeroSubtitle>
          Comprehensive automation solutions for diverse industries
        </HeroSubtitle>
      </HeroSection>
      ...
      <ServiceSection id="automation">
        <ServiceContent>
          <ServiceInfo>
            ...
            <ServiceDescription>
              <p>
                We provide turnkey integrated automation solutions from the shop
                floor (PLC/HMI, SCADA) to Manufacturing Information Systems
                (MIS), maximizing efficiency and minimizing downtime.
              </p>
            </ServiceDescription>
            ...
            <ServiceList>
              <ServiceListItem>
                PLC/SCADA Engineering & Software Development
              </ServiceListItem>
              <ServiceListItem>
                Control Panels Assembly & Field Installation
              </ServiceListItem>
              <ServiceListItem>FAT, Commissioning, Calibration</ServiceListItem>
              <ServiceListItem>
                Custom Software for Maintenance & Planning
              </ServiceListItem>
              <ServiceListItem>
                HMI Screen Design & Data Reporting
              </ServiceListItem>
            </ServiceList>
            ...
            <IndustriesGrid>
              ...
              <IndustryItem>
                <IndustryIcon src={WaterImage} alt="Water" />
                <IndustryName>Water & Wastewater</IndustryName>
              </IndustryItem>
              <IndustryItem>
                <IndustryIcon src={FoodImage} alt="Food" />
                <IndustryName>Food & Beverage</IndustryName>
              </IndustryItem>
              <IndustryItem>
                <IndustryIcon src={PharmaImage} alt="Pharma" />
                <IndustryName>Pharmaceuticals</IndustryName>
              </IndustryItem>
              <IndustryItem>
                <IndustryIcon src={PowerImage} alt="Power" />
                <IndustryName>Power & Utilities</IndustryName>
              </IndustryItem>
              <IndustryItem>
                <IndustryIcon src={SteelImage} alt="Metal" />
                <IndustryName>Steel & Aluminum</IndustryName>
              </IndustryItem>
            </IndustriesGrid>
          </ServiceInfo>
          <ServiceImage src={MainServiceImage} alt="Automation Solutions" />
        </ServiceContent>
      </ServiceSection>
      ...
      <ServiceSection id="panel" alternate>
        <ServiceContent reverse>
          <ServiceInfo>
            ...
            <ServiceDescription>
              <p>
                We custom-design and fabricate all types of electrical and
                control panels, tailored for seamless integration into SCADA and
                automation systems. These services are available both for
                internal projects and external clients.
              </p>
            </ServiceDescription>
            ...
            <ServiceList>
              ...
              <ServiceListItem>
                UL/CE certified panel fabrication
              </ServiceListItem>
            ...
            <FeatureGrid>
              <FeatureCard>
                <FeatureIcon src={QualityImage} alt="Quality" />
                <FeatureTitle>Quality Assurance</FeatureTitle>
                <FeatureText>
                  Rigorous testing ensures reliability and compliance with
                  international standards
                </FeatureText>
              </FeatureCard>

              <FeatureCard>
                <FeatureIcon src={CustomImage} alt="Customization" />
          ...
          <ServiceImage src={PanelImage} alt="Control Panel Assembly" />
        </ServiceContent>
      </ServiceSection>
      ...
      <ServiceSection id="embedded">
        <ServiceContent>
          <ServiceInfo>
            ...
            <ServiceDescription>
              <p>
                Our embedded system engineering team specializes in developing
                custom hardware and firmware solutions, optimizing control
                systems for enhanced performance, and integrating smart devices
                to elevate process automation.
              </p>
            </ServiceDescription>
          ...
          <ServiceImage src={EmbeddedImage} alt="Embedded Systems" />
        </ServiceContent>
      </ServiceSection>
        ...
        <ApproachProcess>
          <ProcessStep>
            ...
            <StepContent>
              ...
              <StepText>
                Requirements gathering, resource planning, budgeting
              </StepText>
            </StepContent>
          </ProcessStep>
          ...
          <ProcessStep>
            ...
            <StepContent>
              ...
              <StepText>
                Architecture finalization, interaction for system mapping
              </StepText>
            </StepContent>
          </ProcessStep>
          ...
          <ProcessStep>
            ...
            <StepContent>
              ...
              <StepText>
                On-site installation and real-world deployment
              </StepText>
            </StepContent>
          </ProcessStep>
        </ApproachProcess>
      ...
      <CallToAction>
        <CTAContent>
          ...
          <CTAText>
            Let our experts help you design and implement the perfect automation
            solution.
          </CTAText>
